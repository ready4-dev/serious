...
## Develop, Test and Apply Time Series Models for Mental Health Economic Analyses
...
[![R-CMD-check](https://github.com/ready4-dev/serious/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ready4-dev/serious/actions/workflows/R-CMD-check.yaml)
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.13894314.svg)](https://doi.org/10.5281/zenodo.1389431)
...
devtools::install_github("ready4-dev/serious")
